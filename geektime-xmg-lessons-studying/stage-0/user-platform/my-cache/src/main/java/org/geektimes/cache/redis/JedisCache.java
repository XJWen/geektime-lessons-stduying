...
public class JedisCache<K extends Serializable, V extends Serializable, Serializers, Deserializers> extends AbstractCache<K, V> {
    ...
    protected Set<K> keySet() {
        ...
        for (byte[] keyBytes : keysBytes) {
            keys.add(deserialize(keyBytes, (Class<ExpirableEntry>) getConfiguration().getKeyType()));
        }
